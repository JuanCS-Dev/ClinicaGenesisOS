...
export function Features() {
  return (
    <section id="manifesto" className="py-32 bg-genesis-surface relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
           
           <div className="order-2 lg:order-1">
              <div className="grid grid-cols-2 gap-4">
                 <div className="bg-genesis-soft p-8 rounded-[32px] hover:bg-genesis-hover transition-colors group">
                    ...
                    <p className="text-sm text-genesis-muted leading-relaxed">Transcrição e SOAP automático. Você conversa, o sistema documenta.</p>
                 </div>
                 <div className="bg-genesis-dark text-white p-8 rounded-[32px] transform translate-y-8 shadow-xl">
                    <ShieldCheck className="w-8 h-8 text-genesis-primary mb-4" />
                    <h4 className="font-bold text-lg mb-2">LGPD Nativo</h4>
                    <p className="text-sm text-genesis-subtle leading-relaxed">Criptografia ponta-a-ponta. Dados no Brasil. Auditoria completa.</p>
                 </div>
                 <div className="bg-blue-50 p-8 rounded-[32px] transform -translate-y-8 group hover:bg-blue-100 transition-colors">
                    ...
                    <p className="text-sm text-genesis-muted leading-relaxed">Lembretes automáticos. Confirmação de consulta. Zero no-shows.</p>
                 </div>
                 <div className="bg-genesis-soft p-8 rounded-[32px] hover:bg-genesis-hover transition-colors">
                    <BarChart3 className="w-8 h-8 text-genesis-dark mb-4" />
                    <h4 className="font-bold text-lg mb-2">Multi-especialidade</h4>
                    <p className="text-sm text-genesis-muted leading-relaxed">Medicina, Nutrição, Psicologia. Cada um com seu fluxo específico.</p>
                 </div>
              </div>
           </div>

           <div className="order-1 lg:order-2">
              <span className="text-genesis-primary font-bold tracking-widest uppercase text-xs mb-4 block">O Problema</span>
              ...
              <div className="space-y-6 text-lg text-genesis-muted font-light leading-relaxed">
                <p>
