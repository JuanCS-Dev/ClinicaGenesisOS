  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {/* Email (read-only) */}
        <div>
          <label className="block text-sm font-medium text-genesis-dark mb-1.5">Email</label>
          <div className="relative">
          ...
          <p className="text-xs text-genesis-subtle mt-1">O email não pode ser alterado</p>
        </div>
        ...
        <div>
          ...
          <select
            ...
            onChange={e =>
              setFormData(prev => ({ ...prev, specialty: e.target.value as SpecialtyType }))
            }
